...
export function WhatsappHero() {
  return (
    <div aria-hidden className="relative h-72 w-72 md:h-[22rem] md:w-[22rem]">
      ...
      {/* phone */}
      <div className="absolute inset-x-16 inset-y-1 overflow-hidden rounded-[1.6rem] bg-white p-2.5" style={{ border: `1px solid ${HAIRLINE}`, boxShadow: ELEV_LG }}>
        {/* status bar / header */}
      ...
      <div className="absolute right-3 top-8 flex h-14 w-14 items-center justify-center rounded-xl bg-white" style={{ border: `1px solid ${HAIRLINE}`, boxShadow: ELEV_MD + ', ' + GLOSS }}>
      ...
      <div className="absolute -left-1 top-24 flex items-center gap-1.5 rounded-lg bg-white px-2.5 py-1.5" style={{ border: `1px solid ${HAIRLINE}`, boxShadow: ELEV_MD }}>
