...
export default function BookCallPill() {
  ...
  return (
    <a
      ...
      data-cursor
      className={`fixed bottom-6 right-6 z-50 flex items-center gap-3 rounded-full border border-white/10 bg-[#BFC9D1] py-2.5 pl-3 pr-4 shadow-2xl transition-all duration-300 ${
